...
-- Variables.
lex:add_rule('variable_builtin', lex:tag(lexer.VARIABLE_BUILTIN, 'A_' * lex:word_match(lexer.VARIABLE_BUILTIN, true)))
...
lex:set_word_list(lexer.KEYWORD, {
  ...
  'Break', 'Catch', 'Continue', 'Else', 'Finally', 'For', 'Global', 'Goto', 'If', 'Local', 'Loop', 'Return', 'Static', 'Throw', 'Try', 'Until', 'While'
})
