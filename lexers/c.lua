...
lex:set_word_list(lexer.FUNCTION_BUILTIN, {
	...
	'islessgreater', 'isunordered', 'fpclassify',
	'labs', 'llabs', 'imaxabs', 'ldiv', 'lldiv', 'imaxdiv', 'fabsf', 'fabsl', 'fmodf', 'fmodl',
	'expf', 'expl', 'logf', 'logl', 'log10f', 'log10l', 'powf', 'powl', 'sqrtf', 'sqrtl',
	'sinf', 'sinl', 'cosf', 'cosl', 'tanf', 'tanl', 'asinf', 'asinl', 'acosf', 'acosl', 'atanf', 'atanl',
	'atan2f', 'atan2l', 'sinhf', 'sinhl', 'coshf', 'coshl', 'tanhf', 'tanhl', 'ceilf', 'ceill',
	'floorf', 'floorl', 'frexpf', 'frexpl', 'ldexpf', 'ldexpl', 'modff', 'modfl',
	'remainderf', 'remainderl', 'remquof', 'remquol', 'fmaf', 'fmal', 'fmaxf', 'fmaxl', 'fminf', 'fminl',
	'fdimf', 'fdiml', 'nanf', 'nanl', 'exp2f', 'exp2l', 'expm1f', 'expm1l', 'log2f', 'log2l',
	'log1pf', 'log1pl', 'cbrtf', 'cbrtl', 'hypotf', 'hypotl', 'asinhf', 'asinhl', 'acoshf', 'acoshl',
	'erff', 'erfl', 'erfcf', 'erfcl', 'tgammaf', 'tgammal', 'lgammaf', 'lgammal', 'truncf', 'truncl',
	'roundf', 'roundl', 'nearbyintf', 'nearbyintl', 'rintf', 'rintl', 'scalbnf', 'scalbnf', 'scalbnl',
	'scalbln', 'scalblnf', 'scalblnl', 'ilogf', 'ilogl', 'logbf', 'logbl', 'nextafterf', 'nextafterl',
	'nexttowardf', 'nexttowardl', 'copysignf', 'copysignl', --
